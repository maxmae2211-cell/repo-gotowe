...
class HttpTest(unittest.TestCase):
    ...
    def test_connect(self):
        ...
        self.assertEqual(
            connect(
                ...
                OptsList(),
                proxy_info(
                    http_proxy_host="8.8.8.8", http_proxy_port=8000, proxy_type="http"
                ),
                True,
            ),
            (True, ("google.com", 443, "/")),
    ...
    def test_proxy_info(self):
        self.assertEqual(
            proxy_info(
                http_proxy_host="127.0.0.1", http_proxy_port="8000", proxy_type="http"
            ).proxy_protocol,
            "http",
        )
        self.assertRaises(
        ...
        self.assertEqual(
            proxy_info(
                http_proxy_host="example.com", http_proxy_port="8000", proxy_type="http"
            ).proxy_host,
            "example.com",
        )
        self.assertEqual(
