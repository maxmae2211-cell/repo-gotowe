...
class UrlTest(unittest.TestCase):
    ...
    def test_parse_url(self):
        ...
        p = parse_url("ws://www.example.com:8000/r")
        self.assertEqual(p[0], "www.example.com")
        self.assertEqual(p[1], 8000)
        self.assertEqual(p[2], "/r")
        self.assertEqual(p[3], False)

        p = parse_url("ws://www.example.com:8000/")
        self.assertEqual(p[0], "www.example.com")
        self.assertEqual(p[1], 8000)
        self.assertEqual(p[2], "/")
        self.assertEqual(p[3], False)
        ...
        p = parse_url("wss://www.example.com:8000/r")
        self.assertEqual(p[0], "www.example.com")
        self.assertEqual(p[1], 8000)
        self.assertEqual(p[2], "/r")
        self.assertEqual(p[3], True)

        p = parse_url("wss://www.example.com:8000/r?key=value")
        self.assertEqual(p[0], "www.example.com")
        self.assertEqual(p[1], 8000)
        ...
        p = parse_url("ws://[2a03:4000:123:83::3]:8000/r")
        self.assertEqual(p[0], "2a03:4000:123:83::3")
        self.assertEqual(p[1], 8000)
        self.assertEqual(p[2], "/r")
        self.assertEqual(p[3], False)
        ...
        p = parse_url("wss://[2a03:4000:123:83::3]:8000/r")
        self.assertEqual(p[0], "2a03:4000:123:83::3")
        self.assertEqual(p[1], 8000)
        self.assertEqual(p[2], "/r")
        self.assertEqual(p[3], True)
