"""
A pure Python version of the HDR histogram.

Adapted from https://github.com/HdrHistogram/HdrHistogram_py by Alec Hothan
...
- core data structure is now a numpy array
