...
<body class="indexfile">
    ...
    <header>
        <div class="content">
            ...
            <h2>
                ...
                <a class="button{% if ibtn.current %} current{% endif %}" {% if ibtn.url %} href="{{ ibtn.url }}" {%
                    endif %}>{{ ibtn.label }}</a>
                {% endfor %}
            </h2>
        ...
        <table class="index" data-sortable>
            <thead>
                ...
                <tr class="tablehead" title="Click to sort">
                    ...
                    {% if region_noun %}
                    <th id="region" class="name" aria-sort="none" data-default-sort-order="ascending" data-shortcut="n">
                        {{ region_noun }}<span class="arrows"></span></th>
                    {% endif %}
                    <th class="spacer">&nbsp;</th>
                    {% if has_arcs %}
                    <th id="statements_coverage" aria-sort="none" data-default-sort-order="descending">coverage<span
                            class="arrows"></span></th>
                    {% endif %}
                    <th id="statements" aria-sort="none" data-default-sort-order="descending" data-shortcut="s">
                        statements<span class="arrows"></span></th>
                    <th id="missing" aria-sort="none" data-default-sort-order="descending" data-shortcut="m">
                        missing<span class="arrows"></span></th>
                    <th id="excluded" aria-sort="none" data-default-sort-order="descending" data-shortcut="x">
                        excluded<span class="arrows"></span></th>
                    {% if has_arcs %}
                    <th class="spacer">&nbsp;</th>
                    <th id="branches_coverage" aria-sort="none" data-default-sort-order="descending">coverage<span
                            class="arrows"></span></th>
                    <th id="branches" aria-sort="none" data-default-sort-order="descending" data-shortcut="b">
                        branches<span class="arrows"></span></th>
                    <th id="partial" aria-sort="none" data-default-sort-order="descending" data-shortcut="p">
                        partial<span class="arrows"></span></th>
                    {% endif %}
                    <th class="spacer">&nbsp;</th>
    ...
    <footer>
        ...
        <aside class="hidden">
            <a id="prevFileLink" class="nav" href="{{ final_html }}" aria-label="Previous file"></a>
            <a id="nextFileLink" class="nav" href="{{ first_html }}" aria-label="Next file"></a>

            <button type="button" class="button_prev_file" data-shortcut="[" aria-label="Previous file"></button>
            <button type="button" class="button_next_file" data-shortcut="]" aria-label="Next file"></button>
            <button type="button" class="button_show_hide_help" data-shortcut="?"
                aria-label="Show or hide help"></button>
        </aside>
    </footer>
