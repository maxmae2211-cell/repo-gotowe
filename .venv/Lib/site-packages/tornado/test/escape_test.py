...
linkify_tests = [
    ...
    (
        "http://userid:password@example.com:8000",
        {},
        '<a href="http://userid:password@example.com:8000">http://userid:password@example.com:8000</a>',  # noqa: E501
    ),
    (
    ...
    (
        "http://userid@example.com:8000",
        {},
        '<a href="http://userid@example.com:8000">http://userid@example.com:8000</a>',
    ),
    (
