...
def corrcoef(x, y=None, rowvar=True, *,
    ...
    >>> R1 = np.corrcoef(xarr)
    >>> R1
    array([[ 1.        ,  0.99256089, -0.68000986],
           [ 0.99256089,  1.        , -0.76492172],
           [-0.68000986, -0.76492172,  1.        ]])
    ...
    >>> R2
    array([[ 1.        ,  0.99256089, -0.68000986,  0.75008178, -0.934284  ,
            -0.99004057],
           [ 0.99256089,  1.        , -0.76492172,  0.82502011, -0.97074098,
            -0.99981569],
           [-0.68000986, -0.76492172,  1.        , -0.99507202,  0.89721355,
             0.77714685],
...
def sinc(x):
    ...
    >>> np.sinc(x)
     array([-3.89804309e-17,  -4.92362781e-02,  -8.40918587e-02, # may vary
            -8.90384387e-02,  -5.84680002e-02,   3.89804309e-17,
           ...
           -3.89804309e-17,   8.50444803e-02,   1.26137788e-01,
            ...
            -5.84680002e-02,  -8.90384387e-02,  -8.40918587e-02,
