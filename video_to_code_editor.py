...
def download_video_and_subs(url, video_filename=None, subs_lang='en'):
    ...
    subs_cmd = ["yt-dlp", "--write-auto-sub", f"--sub-lang={subs_lang}", "--skip-download", url]
...
if __name__ == "__main__":
    ...
    if subs_file:
        ...
        video_file = next((f for f in os.listdir() if f.startswith("moj_film") and f.endswith(".mp4")), None)
        if video_file:
